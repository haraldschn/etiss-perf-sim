...
argParser.add_argument("-e", "--explore", action="store_true", help="Run design space exploration [EXPERIMENTAL]") # Quick fix to run plugin experiment
...
with pluginIni.open('w') as f:
    ...
    # Specify PerformanceExplorerPlugin [EXPERIMENTAL]
    if args.explore:
        f.write("[Plugin PerformanceExplorerPlugin]\n")
